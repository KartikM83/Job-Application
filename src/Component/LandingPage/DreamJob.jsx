        ...
        <div className="flex items-center  px-16 text-white h-[89.5vh]">
            <div className="left  w-[45%] flex flex-col gap-8 ">
                ...
                <div className="text-mine-shaft-200 text-xl">
                    Good life begins wtih a good company. Start explore thousand of job
                    in one place.
                </div>
                <div className="flex gap-3 items-center">

                    <div className="w-[35%] flex flex-col bg-mine-shaft-900 p-3 rounded-lg">
                        <label className="text-sm" htmlFor="name">Job Title</label>
                        <input className="mt-2 w-[75%] text-xs text-mine-shaft-100 bg-transparent focus:outline-none " type="text" id="name" name="name" placeholder="Software Engineer" />
                    </div>

                    <div className="w-[35%] flex flex-col bg-mine-shaft-900 p-3 rounded-lg">
                        <label className="text-sm" htmlFor="name">Job Type</label>
                        <input className="mt-2 w-[75%] text-xs text-mine-shaft-100 bg-transparent focus:outline-none " type="text" id="name" name="name" placeholder="Full Time" />
                    </div>
