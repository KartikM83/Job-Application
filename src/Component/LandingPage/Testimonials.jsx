        ...
        <div className="mt-20 pb-5">
            ...
            <div className="flex gap-8 px-8 flex-wrap justify-center">
                {testimonials.map((test, index) => (
                    <div key={index} className="w-[23%] border-bright-sun-400 border rounded-2xl px-3 py-3 flex flex-col gap-4">
                        <div className="flex gap-3 items-center">
                            <div className="rounded-full overflow-hidden">
                                <img className="w-14 h-14 object-cover" src={test.img} alt={test.name} />
                            </div>
                            <div>
