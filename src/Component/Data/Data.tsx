...
export const companies = [
    "Google", "Amazon", "Figma", "Netflix", "Meta", "Microsoft",
    "Pinterest", "Slack", "Spotify", "Oracle", "Walmart"
];
...
export const work = [
    { img: buildResume, name: "Build Your Resume", desc: "Create a standout resume with your skills." },
    { img: applyJob, name: "Apply for Job", desc: "Find and apply for jobs that match your skills." },
    { img: getHired, name: "Get Hired", desc: "Connect with employers and start your new job." }
];
