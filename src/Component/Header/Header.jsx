...
function Header() {
    ...
    return(
      location.pathname!="/sign-up" &&  location.pathname!="/login"?<div className="w-full h-20 bg-mine-shaft-950 flex items-center justify-between px-8 text-white">
        ...
        <div className='flex items-center justify-center gap-3'>
            ...
            <div className="bg-mine-shaft-900 p-2 rounded-full ">
                ...
                <Box sx={{ color: 'action.active' }}>
                    <Badge color="#ffbd20" variant="dot" sx={{'.MuiBadge-dot': { transform: 'translate(-40%, 40%)',backgroundColor: '#ffbd20', },}}>
